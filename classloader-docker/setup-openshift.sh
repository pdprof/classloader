...
docker build -t classloader:${BUILD_DATE} .

docker tag classloader:${BUILD_DATE} $(oc registry info)/$(oc project -q)/classloader:${BUILD_DATE}

docker push $(oc registry info)/$(oc project -q)/classloader:${BUILD_DATE}
